...
dd <- dataset
dd <- dd[!is.na(dd[,"AGE"])&!is.na(dd[,"REST_BLOOD_PRESSURE"])&!is.na(dd[,"CHOLESTEROL"])&!is.na(dd[,"MAX_HR"])&!is.na(dd[,"REST_HR"]),]
View(dd)
...
dcon <- data.frame (AGE,REST_BLOOD_PRESSURE,CHOLESTEROL,MAX_HR,REST_HR,ST_DIFF_EXERCISE_VS_REST,MAJOR_VESSELS,CIGARETTES,SMOKING_YEARS,EXERCISE_DURATION_MINUTES)
dcon <- dcon[!is.na(dd[,"AGE"])&!is.na(dd[,"REST_BLOOD_PRESSURE"])&!is.na(dd[,"CHOLESTEROL"])&!is.na(dd[,"MAX_HR"])&!is.na(dd[,"REST_HR"])&!is.na(dd[,"ST_DIFF_EXERCISE_VS_REST"]&!is.na(dd[,"MAJOR_VESSELS"])&!is.na(dd[,"CIGARETTES"])&!is.na(dd[,"SMOKING_YEARS"])&!is.na(dd[,"EXERCISE_DURATION_MINUTES"])),]
